...
$find_Name = $find_Details['name'];


if (isset($find_Name)) {
    $sql = "SELECT SID, FirstName, LastName, Email, NearestCity, Course, Guardian, Subject_1, Subject_2, Subject_3, Subject_4, Subject_5, Subject_6 FROM s_details WHERE FirstName LIKE '%$find_Name%'";
} else {
